...
export default function Create() {
    ...
    const levelOptions = [
        { label: "Sedentário (pouco ou nenhum exercício durante a semana)", value: "Sedentário (pouco ou nenhum exercício durante a semana)"},
        { label: "Levemente ativo (exercícios de 3 a 5 vezes na semana)", value: "Levemente ativo (exercicíos 1 a 3 vezes na semana)"},
...
<Text style={styles.label}>Selecione o nível de sua atividade fisíca:</Text>
        <Select 
        control={control}
        name="level"
        placeholder="Selecione o nível de sua atividade fisíca"
